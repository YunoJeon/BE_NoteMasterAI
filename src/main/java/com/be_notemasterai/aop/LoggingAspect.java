package com.be_notemasterai.aop;
...
public class LoggingAspect {
  ...
  @Pointcut("execution(* com.be_notemasterai..controller..*(..))")
  public void apiLayer() {
  }

  @Pointcut("execution(* com.be_notemasterai..service..*(..))")
  ...
  public Object logServiceCall(ProceedingJoinPoint joinPoint) throws Throwable {
    ...
    log.info("\n[{}] ➡️[Service] {} 호출 시작", transactionId, methodName);
    log.info("📍 매개변수: {}\n", args);
    ...
    log.info("\n[{}] ⬅️[Service] {} 호출 종료, 실행 시간: {} ms\n", transactionId, methodName, endTime - startTime);
